...
OOP
 By: Guillaume
 Weight: 5
 Project to be done in teams of 2 people (your team: Kenneth Takyi Mensah , Vincent Koranchie)
...
GitHub repository: AirBnB_clone
File: console.py, models/engine/file_storage.py, tests/0x00. AirBnB clone - The console
Group project
Python
OOP
 By: Guillaume
